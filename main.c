...
void colorir(int cor){
        ...
        "\033[0;33m", // Amarelo
        "\033[0;37m", // Branco
        "\033[1;30m", // Preto (Cinza escuro em negrito)
        "\033[1;34m", // Azul claro
        "\033[1;32m", // Verde claro
        "\033[1;36m", // Ciano claro
        "\033[1;31m", // Vermelho claro
        "\033[1;35m", // Magenta claro
        "\033[1;33m", // Amarelo claro
    };
    (cor >= 0 && cor < 16) ? printf("%s", cores[cor]) : printf("\033[0m");
    #endif
}
